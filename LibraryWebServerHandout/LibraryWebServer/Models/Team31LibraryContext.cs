...
{
    public partial class Team31LibraryContext : DbContext
    {
        public Team31LibraryContext()
        {
        }

        public Team31LibraryContext(DbContextOptions<Team31LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u0942147;Password=alekpass;Database=Team31Library");
            }
        }
